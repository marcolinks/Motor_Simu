...
{'Coeficiente de acoplamento:':}"),
            ...
            # Space(height=1),
            # Text('Send:'),
            Button(text='x', scale=(.05, .025), on_click = lambda:fecha(), rounded = 0.05, color=color.red.tint(-.2), tipo = 'exit'),
            #Slider(),
            #Slider(),
